...
<!-- Canonical URL -->
[#if pageNode?contains('/article')]
<link rel="canonical" href="${cmsfn.link(cmsfn.siteRoot(content))+'investment-news/article/'+data.@name?remove_ending('/')!}" />
[#elseif pageNode?contains('/tag')]
<link rel="canonical" href="${cmsfn.link(cmsfn.siteRoot(content))+'investment-news/tag/'+data.@name?remove_ending('/')!}" />
[#elseif pageNode?contains('/category')]
<link rel="canonical" href="${cmsfn.link(cmsfn.siteRoot(content))+'investment-news/category/'+data.@name?remove_ending('/')!}" />
[#elseif pageNode?contains('/stock')]
<link rel="canonical" href="${cmsfn.link(cmsfn.siteRoot(content))+'investment-news/stock/'+data.@name?remove_ending('/')!}" />
[#elseif pageNode?contains('/fund')]
<link rel="canonical" href="${cmsfn.link(cmsfn.siteRoot(content))+'investment-news/fund/'+data.@name?remove_ending('/')!}" />
[#elseif pageNode?contains('/market')]
<link rel="canonical" href="${cmsfn.link(cmsfn.siteRoot(content))+'investment-news/market/'+data.@name?remove_ending('/')!}" />
[#else]
<link rel="canonical" href="${cmsfn.link(cmsfn.siteRoot(content))+'investment-news'!}" />
[/#if]

[#if currentSite == 'UK']
<!-- Facebook Opengraph -->
[#if pageNode?contains('/article')]
<meta property="og:url" content="${cmsfn.link(cmsfn.siteRoot(content))+'investment-news/article/'+data.@name?remove_ending('/')!}" />
[#elseif pageNode?contains('/tag')]
<meta property="og:url" content="${cmsfn.link(cmsfn.siteRoot(content))+'investment-news/tag/'+data.@name?remove_ending('/')!}" />
[#elseif pageNode?contains('/category')]
<meta property="og:url" content="${cmsfn.link(cmsfn.siteRoot(content))+'investment-news/category/'+data.@name?remove_ending('/')!}" />
[#elseif pageNode?contains('/stock')]
<meta property="og:url" content="${cmsfn.link(cmsfn.siteRoot(content))+'investment-news/stock/'+data.@name?remove_ending('/')!}" />
[#elseif pageNode?contains('/fund')]
<meta property="og:url" content="${cmsfn.link(cmsfn.siteRoot(content))+'investment-news/fund/'+data.@name?remove_ending('/')!}" />
[#elseif pageNode?contains('/market')]
<meta property="og:url" content="${cmsfn.link(cmsfn.siteRoot(content))+'investment-news/market/'+data.@name?remove_ending('/')!}" />
[#else]
<meta property="og:url" content="${cmsfn.link(cmsfn.siteRoot(content))+'investment-news'!}" />
[/#if]
